      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-3 rounded-xl font-semibold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30"
            >
              Login
            </button>
          </form>
          ...
          <p className="text-center mt-6 text-gray-600">
            ...
            <Link href="/create-account" className="text-blue-600 hover:text-blue-700 font-semibold">
              Sign Up
            </Link>
          </p>
        </div>
        ...
        <p className="text-center mt-6 text-gray-500">
          ...
          <Link href="/register-hotel" className="text-blue-600 hover:text-blue-700 font-medium">
            Register Your Hotel
          </Link>
        </p>
      </div>
